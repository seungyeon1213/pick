...
# ---------------------------------------------------
# 음식 데이터 (이름, 이미지, 가격, 예상 배달 시간)
# ---------------------------------------------------
foods = {
    "한식": [
        ("비빔밥", "https://cdn.pixabay.com/photo/2016/03/05/19/02/bibimbap-1238719_640.jpg", 8500, 25),
    ...
    "양식": [
        ("파스타", "https://cdn.pixabay.com/photo/2017/12/09/08/18/spaghetti-3001432_640.jpg", 12000, 35),
        ("피자", "https://cdn.pixabay.com/photo/2017/12/09/08/18/pizza-3007395_640.jpg", 15000, 40)
    ],
    "일식": [
        ("초밥", "https://cdn.pixabay.com/photo/2017/08/17/11/21/sushi-2654036_640.jpg", 13000, 40),
        ("라멘", "https://cdn.pixabay.com/photo/2020/09/18/15/08/ramen-5589723_640.jpg", 11000, 30)
    ],
    "중식": [
        ("짜장면", "https://cdn.pixabay.com/photo/2021/03/23/16/27/noodles-6118249_640.jpg", 8000, 20),
        ("탕수육", "https://cdn.pixabay.com/photo/2022/02/13/06/46/sweet-and-sour-pork-7010455_640.jpg", 14000, 35)
    ],
    "분식": [
        ("떡볶이", "https://cdn.pixabay.com/photo/2022/09/09/09/10/tteokbokki-7442248_640.jpg", 6000, 15),
        ("김밥", "https://cdn.pixabay.com/photo/2017/07/03/20/38/kimbap-2461967_640.jpg", 4000, 10)
    ],
    "패스트푸드": [
        ("햄버거", "https://cdn.pixabay.com/photo/2016/03/05/22/49/hamburger-1238246_640.jpg", 7000, 20),
        ("치킨너겟", "https://cdn.pixabay.com/photo/2020/04/19/11/23/chicken-5061481_640.jpg", 6500, 15)
    ],
    "건강식": [
        ("샐러드", "https://cdn.pixabay.com/photo/2016/03/05/19/02/salad-1238255_640.jpg", 9000, 15),
        ("닭가슴살 도시락", "https://cdn.pixabay.com/photo/2018/05/15/22/19/chicken-breast-3408952_640.jpg", 10000, 25)
    ],
    "디저트": [
        ("아이스크림", "https://cdn.pixabay.com/photo/2015/04/08/13/13/ice-711462_640.jpg", 5000, 10),
...
if st.button("🍴 나에게 맞는 메뉴 추천받기"):
    if not preference:
        ...
        st.markdown(f"💰 **가격:** {price:,}원 | 🕒 **예상 배달 시간:** 약 {time_est}분")
        ...
        if st.button("🚀 이 메뉴로 주문하기"):
            with st.spinner("배달 주문을 접수 중입니다..."):
                time.sleep(2)
            st.success(f"주문 완료! 🛵 {rec_food}이(가) {time_est}분 내 도착 예정입니다 🍽️")
            st.balloons()
...
st.write("---")
st.caption("© 2025 먹PICK! Prototype v4. Made with Streamlit 💛")
